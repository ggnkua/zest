...
# zest_te0726.tcl: Tcl script for re-creating project 'zest_te0726'
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/hdl/zest_te0726_top.vhd"]"\
 "[file normalize "$origin_dir/xdc/te0726.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "zest_te0726"
...
set script_file "zest_te0726.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/vivado/zest_te0726"]"
...
set file "$origin_dir/hdl/zest_te0726_top.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "library" -value "work" -objects $file_obj
...
set file "[file normalize "$origin_dir/xdc/te0726.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/xdc/te0726.xdc"
set file [file normalize $file]
